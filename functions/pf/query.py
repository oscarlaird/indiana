...
def fetch_contexts(q, top_k=1) -> pinecone.QueryResponse:
    ...
    contexts = vector_db.index.query(vector=v, top_k=top_k, include_values=False, include_metadata=True)
